...
#define IOT_DEBUG(format, ...) ESP_LOGD(__func__, format, ##__VA_ARGS__);
	/*{\
...
#define IOT_INFO(format, ...) ESP_LOGI(__func__, format, ##__VA_ARGS__);
	/*{\
	printf(__VA_ARGS__); \
	printf("\n"); \
	}*/
...
#define IOT_WARN(format, ...) ESP_LOGW(__func__, format, ##__VA_ARGS__);
	/*{ \
...
#define IOT_ERROR(format, ...) ESP_LOGE(__func__, format, ##__VA_ARGS__);
	/*{ \
