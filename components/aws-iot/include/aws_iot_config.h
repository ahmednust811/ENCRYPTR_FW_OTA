...
#define AWS_IOT_MQTT_HOST              		"a38uvazz9jce5o-ats.iot.us-east-2.amazonaws.com" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
#define AWS_IOT_MQTT_PORT              		8883 ///< default port for MQTT/S
#define AWS_IOT_MQTT_CLIENT_ID         		"194005" ///< MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME 		   		"194005" ///< Thing Name of the Shadow this device is associated with


#define AWS_IOT_ROOT_CA_NVS_VAR_NAME   		"ca" ///< Root CA file name
#define AWS_IOT_CERTIFICATE_NVS_VAR_NAME	"iot_thing_cert" ///< device signed certificate file name
#define AWS_IOT_PRIVATE_KEY_NVS_VAR_NAME   	"iot_thing_key" ///< Device private key filename
#define AWS_IOT_CLAIM_CERT_NVS_VAR_NAME		"claim_cert"
#define AWS_IOT_CLAIM_KEY_NVS_VAR_NAME		"claim_key"
// =================================================
...
#define MAX_SIZE_OF_UNIQUE_CLIENT_ID_BYTES 40  ///< Maximum size of the Unique Client Id. For More info on the Client Id refer \ref response "Acknowledgments"
#define MAX_SIZE_CLIENT_ID_WITH_SEQUENCE MAX_SIZE_OF_UNIQUE_CLIENT_ID_BYTES + 10 ///< This is size of the extra sequence number that will be appended to the Unique client Id
#define MAX_SIZE_CLIENT_TOKEN_CLIENT_SEQUENCE MAX_SIZE_CLIENT_ID_WITH_SEQUENCE + 20 ///< This is size of the the total clientToken key and value pair in the JSON
#define MAX_ACKS_TO_COMEIN_AT_ANY_GIVEN_TIME 5 ///< At Any given time we will wait for this many responses. This will correlate to the rate at which the shadow actions are requested
#define MAX_THINGNAME_HANDLED_AT_ANY_GIVEN_TIME 2 ///< We could perform shadow action on any thing Name and this is maximum Thing Names we can act on at any given time
...
#define MAX_JSON_TOKEN_CB_EXPECTED 5
